...
public class MVCPortletExtended extends MVCPortlet {
	...
	boolean hideDefaultSuccessMessage = ParamUtil.getBoolean(portletRequest,
	...
	SessionMessages.add(portletRequest, PortalUtil
	...
	return namespace.concat(StringPool.PERIOD)
		.concat(MVCRenderConstantsExt.MVC_PATH_REQUEST_ATTRIBUTE_NAME);
    }
    ...
    protected void checkPermissions(PortletRequest portletRequest,
	    Method method) throws PrincipalException {
	...
	if (primKey == null || primKey.isEmpty())
	    primKey = PortletPermissionUtil
		    .getPrimaryKey(themeDisplay.getLayout().getPlid(), name);
	...
	try {
		...
		if (!method.getName().equals(actionName) || !method
